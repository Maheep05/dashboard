...
export function Sidenav() {
    ...
    return (
        <div className='hidden py-8 px-4 sm:flex flex-col gap-6 w-80'>
            ...
            <div className='flex flex-col justify-center gap-6'>
                ...
                <div className='flex flex-col justify-center gap-2'>
                    ...
                    <div className='flex flex-col px-8 gap-2'>
                        <h1 className='font-semibold text-lg cursor-pointer'>Analytics</h1>
                        <h1 className='cursor-pointer font-semibold text-lg text-[#5F6980]'>Finance</h1>
                        <h1 className='font-semibold cursor-pointer text-lg text-[#5F6980]'>Job Board</h1>
                    </div>
                </div>
