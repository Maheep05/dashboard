export function PremiumCard() {
    return (
        <div className="bg-[#282828] rounded-xl gap-4 md:gap-1 p-6  flex flex-col justify-center md:flex-row items-center h-40 md:h-32 md:justify-between">
            ...
            {/* Button to upgrade */}
            <div className="flex gap-2 cursor-pointer px-6 py-3 rounded-3xl bg-white h-12 items-center w-40"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
